...
current_location = {2,2} -- first value is y, second value is x.
current_number = numpad[current_location[1]][current_location[2]] -- starting value is in the middle, 5
...
all_commands = stringx.split(input, '\n')

for key_number, instructions in ipairs(all_commands) do
    for i = 1, #instructions do
        instruction = string.sub(instructions, i, i)
